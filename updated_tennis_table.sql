...
INSERT INTO ServesTotal_1 (ServesTotal_1 ,  Serve1st_1 ,  Serve1stPCT_1 )
SELECT ServesTotal_1 ,  Serve1st_1 ,  Serve1stPCT_1 
FROM atp_megatable;
...
INSERT INTO ServesTotal_2 (ServesTotal_2 ,  Serve1st_2 ,  Serve1stPCT_2 )
SELECT ServesTotal_2 ,  Serve1st_2 ,  Serve1stPCT_2 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS ServesTotal_overall_1 (
  ID INT,
  ServesTotal_A_1 FLOAT ,
  Serve1st_A_1 FLOAT ,
  Serve1stPCT_A_1 FLOAT ,
...
INSERT INTO ServesTotal_overall_1 (ServesTotal_A_1 ,  Serve1st_A_1 ,  Serve1stPCT_A_1 )
SELECT ServesTotal_A_1 ,  Serve1st_A_1 ,  Serve1stPCT_A_1 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS ServesTotal_overall_2 (
  ID INT,
  ServesTotal_A_2 FLOAT ,
  Serve1st_A_2 FLOAT,
  Serve1stPCT_A_2 FLOAT,
...
INSERT INTO ServesTotal_overall_2 (ServesTotal_A_2 ,  Serve1st_A_2 ,  Serve1stPCT_A_2 )
SELECT ServesTotal_A_2 ,  Serve1st_A_2 ,  Serve1stPCT_A_2 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS ServesTotal_last5_1 (
  ID INT,
  ServesTotal_L5_1 FLOAT ,
  Serve1st_L5_1 FLOAT,
  Serve1stPCT_L5_1 FLOAT,
...
INSERT INTO ServesTotal_last5_1 (ServesTotal_L5_1 ,  Serve1st_L5_1 ,  Serve1stPCT_L5_1 )
SELECT ServesTotal_L5_1 ,  Serve1st_L5_1 ,  Serve1stPCT_L5_1 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS ServesTotal_last5_2 (
  ID INT,
  ServesTotal_L5_2 FLOAT ,
  Serve1st_L5_2 FLOAT,
  Serve1stPCT_L5_2 FLOAT,
...
INSERT INTO ServesTotal_last5_2 (ServesTotal_L5_2 ,  Serve1st_L5_2 ,  Serve1stPCT_L5_2 )
SELECT ServesTotal_L5_2 ,  Serve1st_L5_2 ,  Serve1stPCT_L5_2 
FROM atp_megatable;
...
INSERT INTO Serve1st_1 (Serve1st_1 ,  Serve1stWon_1 ,  Serve1stWonPCT_1 )
SELECT Serve1st_1 ,  Serve1stWon_1 ,  Serve1stWonPCT_1 
FROM atp_megatable;
...
INSERT INTO Serve1st_2 (Serve1st_2 ,  Serve1stWon_2 ,  Serve1stWonPCT_2 )
SELECT Serve1st_2 ,  Serve1stWon_2 ,  Serve1stWonPCT_2 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS Serve1st_overall_1 (
  ID INT,
  Serve1st_A_1 FLOAT ,
  Serve1stWon_A_1 FLOAT,
  Serve1stWonPCT_A_1 FLOAT,
...
INSERT INTO Serve1st_overall_1 (Serve1st_A_1 ,  Serve1stWon_A_1 ,  Serve1stWonPCT_A_1 )
SELECT Serve1st_A_1 ,  Serve1stWon_A_1 ,  Serve1stWonPCT_A_1 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS Serve1st_overall_2 (
  ID INT,
  Serve1st_A_2 FLOAT ,
  Serve1stWon_A_2 FLOAT,
  Serve1stWonPCT_A_2 FLOAT,
...
INSERT INTO Serve1st_overall_2 (Serve1st_A_2 ,  Serve1stWon_A_2 ,  Serve1stWonPCT_A_2 )
SELECT Serve1st_A_2 ,  Serve1stWon_A_2 ,  Serve1stWonPCT_A_2 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS Serve1st_last5_1 (
  ID INT,
  Serve1st_L5_1 FLOAT ,
  Serve1stWon_L5_1 FLOAT,
  Serve1stWonPCT_L5_1 FLOAT,
...
INSERT INTO Serve1st_last5_1 (Serve1st_L5_1 ,  Serve1stWon_L5_1 ,  Serve1stWonPCT_L5_1 )
SELECT Serve1st_L5_1 ,  Serve1stWon_L5_1 ,  Serve1stWonPCT_L5_1 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS Serve1st_last5_2 (
  ID INT,
  Serve1st_L5_2 FLOAT ,
  Serve1stWon_L5_2 FLOAT,
  Serve1stWonPCT_L5_2 FLOAT,
...
INSERT INTO Serve1st_last5_2 (Serve1st_L5_2 ,  Serve1stWon_L5_2 ,  Serve1stWonPCT_L5_2 )
SELECT Serve1st_L5_2 ,  Serve1stWon_L5_2 ,  Serve1stWonPCT_L5_2 
FROM atp_megatable;
...
INSERT INTO BreakPointsTotal_1 (BreakPointsTotal_1 ,  BreakPointsConverted_1 ,  BreakPointsConvertedPCT_1 )
SELECT BreakPointsTotal_1 ,  BreakPointsConverted_1 ,  BreakPointsConvertedPCT_1 
FROM atp_megatable;
...
INSERT INTO BreakPointsTotal_2 (BreakPointsTotal_2 ,  BreakPointsConverted_2 ,  BreakPointsConvertedPCT_2 )
SELECT BreakPointsTotal_2 ,  BreakPointsConverted_2 ,  BreakPointsConvertedPCT_2 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS BreakPointsTotal_overall_1 (
  ID INT,
  BreakPointsTotal_A_1 FLOAT ,
  BreakPointsConverted_A_1 FLOAT ,
  BreakPointsConvertedPCT_A_1 FLOAT ,
...
INSERT INTO BreakPointsTotal_overall_1 (BreakPointsTotal_A_1 ,  BreakPointsConverted_A_1 ,  BreakPointsConvertedPCT_A_1 )
SELECT BreakPointsTotal_A_1 ,  BreakPointsConverted_A_1 ,  BreakPointsConvertedPCT_A_1 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS BreakPointsTotal_overall_2 (
  ID INT, 
  BreakPointsTotal_A_2 FLOAT ,
  BreakPointsConverted_A_2 FLOAT,
  BreakPointsConvertedPCT_A_2 FLOAT ,
...
INSERT INTO BreakPointsTotal_overall_2 (BreakPointsTotal_A_2 ,  BreakPointsConverted_A_2 ,  BreakPointsConvertedPCT_A_2 )
SELECT BreakPointsTotal_A_2 ,  BreakPointsConverted_A_2 ,  BreakPointsConvertedPCT_A_2 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS BreakPointsTotal_last_1 (
  ID INT,
  BreakPointsTotal_L5_1 FLOAT ,
  BreakPointsConverted_L5_1 FLOAT ,
  BreakPointsConvertedPCT_L5_1 FLOAT ,
...
INSERT INTO BreakPointsTotal_last_1 (BreakPointsTotal_L5_1 ,  BreakPointsConverted_L5_1 ,  BreakPointsConvertedPCT_L5_1 )
SELECT BreakPointsTotal_L5_1 ,  BreakPointsConverted_L5_1 ,  BreakPointsConvertedPCT_L5_1 
FROM atp_megatable;


CREATE TABLE IF NOT EXISTS BreakPointsTotal_last5_2 (
  ID INT,
  BreakPointsTotal_L5_2 FLOAT ,
  BreakPointsConverted_L5_2 FLOAT ,
  BreakPointsConvertedPCT_L5_2 FLOAT ,
...
INSERT INTO BreakPointsTotal_last_2 (BreakPointsTotal_L5_2 ,  BreakPointsConverted_L5_2 ,  BreakPointsConvertedPCT_L5_2 )
SELECT BreakPointsTotal_L5_2 ,  BreakPointsConverted_L5_2 ,  BreakPointsConvertedPCT_L5_2 
FROM atp_megatable;
